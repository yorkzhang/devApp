...
function Sidebar({ routes, image, background, userId, filterSubPage}) {
  ...
  const createLinks = (routes) => {
    return routes.map((prop, key) => {
      ...
      // if(filterSubPage.includes(prop.views)){
      //   // console.log("props.views :", prop.views)
      // }
      if (prop.collapse) {
        var st = {};
        ...
        return (
          ...
          >
            ...
            <Collapse in={state[prop.state]}>
              <div>
                {/* {console.log("從routes.js : ", prop.views)} */}
                <Nav as="ul">{createLinks(prop.views)}</Nav>
              </div>
            </Collapse>
            {/* { filterSubPage.includes(prop.views)
            ?
              <Collapse in={state[prop.state]}>
                <div>
      ...
      return (
        ...
        >
          <Nav.Link to={prop.layout + prop.path} as={Link}>
            {filterSubPage.includes(prop.name)? (
    ...
    <>
      <div className="sidebar" data-color={background} data-image={image}>
        <div className="sidebar-wrapper"  >
          ...
          <div className="logo d-flex flex-column align-items-center justify-content-start">
            {/* search by className and modify style */}
            <div className="logo-img">
              <Link to="/admin/dashboard">
                <img src={require("assets/img/MetaAgeLogo.png")} alt="..." />
              </Link>
            </div>
            <a href="#" className="simple-text  logo-normal"> Azure雲端管理系統 </a>
          </div>


          <div className="user">
            <div className="photo">
              <img alt="..." src={require("assets/img/mario.png")} />
            </div>
            <div className="info">
              <a
