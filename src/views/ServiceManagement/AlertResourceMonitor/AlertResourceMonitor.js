...
export default function AlertResourceMonitor() {
  ...
  const GetGrafanaUrl =  async() =>{
      ...
      let res = await axios.get(`https://api.metaage.pro/api/GraganaUrl/V1/GetGraFanaUrl?QureyCustomerTenantId=${CustomerTenantId}&QureySubpageID=SPI035`)
